...
import ui
ui.TXTT=" "
UX=ui.threading.Thread(target=ui.UI)
UX.start()
...
def sendEmail(to, content):
    ...
    server.login('b74579009@gmail.com', 'Grassmango@404')
    server.sendmail('b74579009@gmail.com', to, content)
    server.close()
...
if __name__ == "__main__":
    ...
    # if 1:
        ...
        if 'your name' in query or 'name' in query:
            speak('hi , i am bella.')
            ...
            if 'vice principal' in query:
                ...
                speak('The principals room is located on the third floor of B block, Room number B 2 0 4')
            ...
            speak('Miss Shine George is the head of the civil engineering department')

        elif 'HOD of science and humanities' in query or 'head of science and humanities' in query or 'Ann Neetha Sabu' in query:
            speak('Miss Ann Neetha Sabu is the head of the S and H department')
